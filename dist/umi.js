(function(e) {
  ...
  function i(e) {
    return (
      ...
      '' +
      ({
        0: 'vendors~p__detail__index~p__form__index~p__home__index~p__result__index',
        1: 'p__detail__index',
        2: 'p__form__index',
        3: 'p__home__index',
        4: 'p__result__index',
    ...
    function D(e) {
      for (var t = O(C); null !== t; ) {
        if (null === t.callback) R(C);
          ...
          R(C), (t.sortIndex = t.expirationTime), T(I, t);
        }
        t = O(C);
      }
    }
      ...
      try {
        for (
          ...
          if (null !== u) {
            ...
            (n = t.unstable_now()),
              'function' === typeof l ? (A.callback = l) : A === O(I) && R(I),
              D(n);
          } else R(I);
          A = O(I);
        }
      ...
      (t.unstable_scheduleCallback = function(e, n, a) {
        ...
        return (
          ...
          l > u
            ? ((e.sortIndex = l),
              T(C, e),
              null === O(I) && e === O(C) && (L ? i() : (L = !0), o(U, l - u)))
      ...
      return [
        ...
        function(e, r) {
          ...
          for (var T = '', O = 0, R = 0; R < k.length; R++) {
            ...
            var A = E.groups;
            if (h) {
              var j = [P].concat(C, I, d);
              void 0 !== A && j.push(A);
              var M = String(r.apply(void 0, j));
            } else M = w(P, d, I, C, A, r);
            I >= O && ((T += d.slice(O, I) + M), (O = I + P.length));
          }
          return T + d.slice(O);
        },
      ];
  ...
  Yhre: function(e, t, n) {
    ...
    if (i) {
      if (
        ...
        I = function(e) {
          return c(this, I), new P(p(e));
        };
        for (var G, q = (I[T] = P[T]), K = g(P), Y = 0; K.length > Y; )
          (G = K[Y++]) in I || a(I, G, P[G]);
        q.constructor = I;
      }
      v && h(_) !== A && v(_, A);
      var Q = new C(new I(2)),
    ...
    b(I, E), b(C, S), (e.exports = { ArrayBuffer: I, DataView: C });
  },
  Z4nd: function(e, t, n) {
    'use strict';
    var r = n('I+eb'),
  ...
  bCY9: function(e, t, n) {
    ...
    o.register({
      apply: n('Bm4k'),
      path: 'C:/Users/LJY/Desktop/GitHub/react-demo/src/app.ts',
    }),
  ...
  fdAy: function(e, t, n) {
    ...
    e.exports = function(e, t, n, s, d, x, k) {
      ...
      var E,
        ...
        P = !1,
        I = e.prototype,
        C = I[g] || I['@@iterator'] || (d && I[d]),
        _ = (!v && C) || O(d),
        A = ('Array' == t && I.entries) || C;
      if (
        (A &&
          ((E = i(A.call(new e()))),
          h !== Object.prototype &&
        ...
        if (((S = { values: O(m), keys: x ? _ : O(y), entries: O(b) }), k))
          for (T in S) (v || P || !(T in I)) && c(I, T, S[T]);
  ...
  mGGf: function(e, t, n) {
    ...
    var r = n('I+eb'),
      ...
      W = c(
        function(e, t) {
          R(this, { type: O, iterator: b(P(e).entries), kind: t });
        },
        'Iterator',
        function() {
          var e = I(this),
  ...
  pNMO: function(e, t, n) {
    ...
    q[B][W] || R(q[B], W, q[B].valueOf), L(q, z), (_[F] = !0);
  },
  pevA: function(e, t, n) {
    'use strict';
    var r = n('I+eb'),
      ...
      i = [
        {
          ...
          component: Object(r['dynamic'])({
            loader: () =>
              Promise.all([n.e(0), n.e(3)]).then(n.bind(null, 'FCkD')),
          }),
          exact: !0,
        },
        {
          ...
          component: Object(r['dynamic'])({
            loader: () =>
              Promise.all([n.e(0), n.e(1)]).then(n.bind(null, 'ipAC')),
          }),
          exact: !0,
        },
        {
          ...
          component: Object(r['dynamic'])({
            loader: () =>
              Promise.all([n.e(0), n.e(2)]).then(n.bind(null, 'APdg')),
          }),
          exact: !0,
        },
        {
          ...
          component: Object(r['dynamic'])({
            loader: () =>
              Promise.all([n.e(0), n.e(4)]).then(n.bind(null, 'NI3x')),
          }),
          exact: !0,
        },
      ];
  ...
  yl30: function(e, t, n) {
    ...
    function M() {
      if (C) {
        var e = C,
          t = _;
        if (((_ = C = null), A(e), t)) for (e = 0; e < t.length; e++) A(t[e]);
      }
    }
    function N(e, t) {
      return e(t);
    ...
    var jr = !1;
    function Mr() {
      Pr && (Pr.detachEvent('onpropertychange', Nr), (Ir = Pr = null));
    }
    function Nr(e) {
      if ('value' === e.propertyName && _r(Ir))
        if (((e = Rr(Ir, e, vt(e))), F)) ht(e);
        else {
          F = !0;
          try {
            N(Cr, e);
    ...
    function Lr(e, t, n) {
      'focus' === e
        ? (Mr(), (Pr = t), (Ir = n), Pr.attachEvent('onpropertychange', Nr))
        : 'blur' === e && Mr();
    }
    function Dr(e) {
    ...
    function Lo(e, t, n) {
      if (Co.current !== Io) throw Error(a(168));
      Po(Co, t), Po(_o, n);
    }
    function Do(e, t, n) {
      var r = e.stateNode;
    ...
    function Zi(e, t) {
      switch ((Po(Yi, t), Po(Ki, e), Po(qi, Gi), (e = t.nodeType), e)) {
        case 9:
        case 11:
    ...
    function ta(e) {
      for (var t = e; null !== t; ) {
        if (13 === t.tag) {
          ...
          if (
            null !== n &&
            ((n = n.dehydrated), null === n || n.data === Rn || n.data === Pn)
          )
            return t;
            ...
            if (((e = Qi(qi.current)), Ga(t))) {
              ...
              switch (
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Ie(e, r), (c = Pe(e, r)), nn('invalid', e), yn(n, 'onChange');
                  break;
                case 'option':
                  c = Ne(e, r);
                  break;
    ...
    function gu(e) {
      switch (e.tag) {
        ...
        case 3:
          if (($i(), Ro(_o), Ro(Co), (t = e.effectTag), 0 !== (64 & t)))
            throw Error(a(285));
    ...
    function Pl(e, t) {
      ...
      if (0 !== n) {
        ...
        if ((ql(), (e === Xu && n === tl) || jl(e, n), null !== el)) {
          ...
          if ((Rl(e), e.callbackNode === t)) return Pl.bind(null, e);
        }
      }
      return null;
    }
    ...
    function Hl(e, t) {
      ...
      if (
        ...
        (tn = !!In), (Cn = In = null), (e.current = n), (fl = o);
        do {
          try {
            for (w = e; null !== fl; ) {
              var E = fl.effectTag;
  ...
  zlVK: function(e, t, n) {
    ...
    function R(e) {
      var t = e.route,
        n = e.opts,
        r = e.props,
        o = I(h({}, n, { routes: t.routes || [], rootRoutes: n.rootRoutes })),
        i = t.component,
        u = t.wrappers;
      if (i) {
    ...
    function C(e) {
      ...
      return (
        ...
        a.createElement(u.Router, { history: t }, I(n))
      );
    }
    function _(e) {
    ...
    (t.renderClient = j), (t.renderRoutes = I);
  },
  'zu+z': function(e, t, n) {
    var r = n('I+eb'),
      o = n('qY7S');
